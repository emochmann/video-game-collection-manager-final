 ...
 * Course: CEN 3024C
 * Date: April 13, 2026
 * Provides the graphical user interface (GUI) for the Video Game Collection Manager application.
 *
 * This class allows users to add, update, delete, search, and view video games stored
 * in a database. It interacts with the GameDatabaseService to perform all database operations.
 *
 * The GUI includes input fields for game details, a table to display stored games,
 * and buttons for user actions.
 *
 * This class serves as the main interface between the user and the system.
 */
...
public class GameManagerGUI extends JFrame {
    ...
    /**
     * Initializes the main window, layout, and visual components of the GUI.
     * Sets up panels, labels, and connects to the database file.
     */
    ...
    /**
     * Creates the form panel that contains input fields and action buttons
     * for managing video games.
     *
     * @return a JPanel containing form components
     */
    ...
    /**
     * Creates the panel that displays the table of video games along with
     * search functionality and file controls.
     *
     * @return a JPanel containing the table and controls
     */
    ...
    /**
     * Attaches event listeners to all buttons to handle user interactions
     * such as adding, updating, deleting, and searching for games.
     */
private void addButtonListeners() {
    ...
    /**
     * Refreshes the table to display the current list of video games
     * from the database.
     */
    ...
    /**
     * Retrieves user input from the form fields, validates the data,
     * and creates a VideoGame object.
     *
     * @param gameId the ID assigned to the video game
     * @return a VideoGame object if input is valid, otherwise null
     */
    ...
    /**
     * Clears all input fields and resets the table selection.
     */
    ...
    /**
     * Adds a hover effect to a button by changing its appearance
