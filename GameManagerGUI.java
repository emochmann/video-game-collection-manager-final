...
public class GameManagerGUI extends JFrame {
    ...
    public GameManagerGUI(GameService gameService) {
    ...
    private void addButtonListeners() {
        ...
        updateButton.addActionListener(e -> {
            ...
            if (updatedGame != null) {
                ...
                if (!gameService.updateGame(gameId, 1, updatedGame.getTitle())) success = false;
                if (!gameService.updateGame(gameId, 2, updatedGame.getGenre())) success = false;
                if (!gameService.updateGame(gameId, 3, updatedGame.getPlatform())) success = false;
                if (!gameService.updateGame(gameId, 4, String.valueOf(updatedGame.getReleaseYear()))) success = false;
                if (!gameService.updateGame(gameId, 5, String.valueOf(updatedGame.getRating()))) success = false;
        ...
        searchButton.addActionListener(e -> {
            ...
            for (VideoGame game : gameService.searchByTitle(searchText)) {
                Object[] row = {
                        game.getGameId(),
                        game.getTitle(),
                        game.getGenre(),
        ...
        loadFileButton.addActionListener(e -> {
            ...
            if (result == JFileChooser.APPROVE_OPTION) {
                ...
                if (gameService.loadGamesFromFile(filePath)) {
                    JOptionPane.showMessageDialog(this, "Games loaded successfully.");
                    refreshTable();
                } else {
 ...
 */
    private void refreshTable() {
        ...
        for (VideoGame game : gameService.getAllGames()) {
            Object[] row = {
                    game.getGameId(),
                    game.getTitle(),
                    game.getGenre(),
